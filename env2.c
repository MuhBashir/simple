...
/**
 * copy_info_r - copies info to create
 * a new  env or alias
...
/**
 * set_env_r - sets an environment variable
 *
...
/**
 * _setenv_r - compares env variables names
...
int _setenv_r(shell_data *datash)
{
	...
	set_env_r(datash->args[1], datash->args[2], datash);

	return (1);
}

/**
 * _unsetenv_r - deletes a environment variable
 *
