...
/**
 * add_nodes_r - add separators and command lines in the lists
 *
...
/**
 * go_next_r - go to the next command line stored
 *
...
/**
 * split_commands_r - splits command lines according to
...
int split_commands_r(shell_data *datash, char *input)
{
	...
	add_nodes_r(&head_s, &head_l, input);
...
/**
 * split_line_r - tokenizes the input string
 *
 * @input: input string.
